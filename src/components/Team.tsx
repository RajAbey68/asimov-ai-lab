...
const teamMembers = [
  ...
  },
  {
    ...
    bio: "Dual-qualified barrister and solicitor. Founder of CAAIRO (Centre for AI Risk & Opportunity). Specialises in AI governance, IP, and regulatory compliance for technology businesses via ADL Legal.",
