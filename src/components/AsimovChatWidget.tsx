...
const AsimovChatWidget = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "⚠️ You are interacting with an AI system. Responses are AI-generated and are not professional advice.\n\nHello, I'm SIMO — Structured Insights for Meaningful Outcomes.\nI provide guidance on AI governance and compliance based on established frameworks. I may occasionally misunderstand or make errors.\nPlease review my responses carefully and consult a qualified human professional whenever needed.\n\nHow can I assist you today?"
    }
  ]);
