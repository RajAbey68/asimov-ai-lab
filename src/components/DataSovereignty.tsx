...
const DataSovereignty = () => {
    return (
        <section className="py-24 section-alt text-slate-900 relative overflow-hidden">
            {/* Background decoration */}
            <div className="absolute top-0 right-0 w-1/3 h-full bg-blue-500/5 blur-3xl pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-1/3 h-full bg-blue-200/10 blur-3xl pointer-events-none" />

            <div className="container mx-auto px-4 relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-8">
                        <div className="inline-block">
                            <span className="text-brand-blue font-bold tracking-wider uppercase bg-blue-50 px-4 py-2 rounded-full border border-blue-100 text-sm">
                        ...
                        <div className="space-y-6 pt-4">
                            {[
                                ...
                                <div key={i} className="flex gap-4">
                                    <div className="mt-1 bg-blue-50 p-3 rounded-lg h-fit border border-blue-100">
                    ...
                    <div className="relative">
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-lg relative overflow-hidden">
                            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-brand-blue to-blue-400" />

                            <div className="space-y-6">
                                <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                                    <span className="font-mono text-sm text-slate-500">System Status</span>
                                    <span className="flex items-center text-green-600 text-sm font-bold gap-2">
                                ...
                                <div className="space-y-4 font-mono text-sm">
                                    <div className="flex items-center gap-3 text-slate-700">
                                        ...
                                        <span>PII Redaction Layer: <span className="text-green-600 font-semibold">Active</span></span>
                                    </div>
                                    <div className="flex items-center gap-3 text-slate-700">
                                        <CheckCircle className="w-4 h-4 text-brand-blue" />
                                        <span>Model Gateway: <span className="text-green-600 font-semibold">Private Endpoint</span></span>
                                    </div>
                                    <div className="flex items-center gap-3 text-slate-700">
                                        <CheckCircle className="w-4 h-4 text-brand-blue" />
                                        <span>Audit Logging: <span className="text-green-600 font-semibold">Enforced (SHA-256)</span></span>
                                    </div>
                                </div>
