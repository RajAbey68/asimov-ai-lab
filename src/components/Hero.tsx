      ...
      <div className="container mx-auto px-4 py-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 backdrop-blur-sm">
            ...
            <span className="text-sm text-accent font-medium">AI Risk Assessment & Project Delivery</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-primary-foreground/80 max-w-2xl mx-auto">
            Comprehensive AI risk assessment and expert project delivery to transform your vision into reality, safely and effectively.
          </p>
