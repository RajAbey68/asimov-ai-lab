...
const Framework = () => {
  ...
  const frameworks = [
    ...
    { name: "MBAD Delivery", lifecycle: true, focus: "Tactical Execution & Governance-as-Code" }
  ];
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <Tabs defaultValue="lifecycle" className="w-full">
              <TabsList className="grid w-full max-w-4xl mx-auto grid-cols-5 mb-12">
                ...
                <TabsTrigger value="bmad">Delivery : MBAD</TabsTrigger>
              ...
              <TabsContent value="bmad" className="space-y-12">
                ...
                <div className="text-center mb-12">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
                    ...
                    <span className="text-sm text-primary font-medium">Tactical Application Delivery</span>
                  </div>
                  <h2 className="text-3xl md:text-4xl font-bold mb-4">MBAD: The Delivery Engine</h2>
                  <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                    Model-Based Application Delivery (MBAD) is our proprietary framework for translating high-level governance requirements into deployed, compliant code with zero context loss.
                  </p>
                </div>

                {/* Infographic Section */}
                <div className="mb-16 flex flex-col items-center">
                  <Card className="border-border overflow-hidden w-full max-w-5xl shadow-2xl">
                    <div className="relative">
                      <img
                        src={mbadInfographic}
                        alt="MBAD Framework Information Architecture"
                        className="w-full h-auto object-cover"
                      />
                    </div>
                    <CardHeader className="bg-gradient-to-r from-background to-accent/5 border-b border-border">
                      <CardTitle className="text-xl flex items-center gap-2">
                        <Rocket className="w-5 h-5 text-accent" />
                        From Ideation to Deployment
                      </CardTitle>
                      <CardDescription>
                        The MBAD cycle ensures governance is not a bottleneck but a "paved road" for high-velocity delivery.
                      </CardDescription>
                    </CardHeader>
                  </Card>
                </div>
                ...
                <div className="max-w-4xl mx-auto mb-16 space-y-8">
                  <div className="prose prose-lg dark:prose-invert max-w-none">
                    <h3 className="text-2xl font-bold text-foreground">Closing the Gap Between Governance and Code</h3>
                    <p className="text-muted-foreground leading-relaxed">
                      Traditional software delivery often treats governance, compliance, and security as "gates" or "hurdles" that exist outside the development lifecycle. This creates a dangerous "Context Gap" where the intent of a policy (e.g., "AI must be fair") is lost by the time a developer writes a function.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
                      <strong>MBAD (Model-Based Application Delivery)</strong> fundamentally inverts this model. Instead of auditing code <em>after</em> it is written, MBAD embeds the requirement <em>into the generation process itself</em>.
                    </p>

                    <h4 className="text-xl font-semibold text-foreground mt-8 mb-4">The Cognitive Core: Persistent Context</h4>
                    <p className="text-muted-foreground leading-relaxed">
                      At the heart of MBAD is a persistent cognitive layer (powered by NotebookLM) that maintains a "Living Model" of the system. This model contains not just the technical specs, but the <strong>Governance Mandates</strong>, <strong>Risk Controls</strong>, and <strong>Business Goals</strong>.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
                      When an <em>Architect Agent</em> designs a comprehensive system component, it doesn't just look at the feature request; it cross-references the <strong className="text-accent">EU AI Act compliance model</strong> and the <strong className="text-accent">NIST Risk Framework</strong> stored in the core. The resulting architecture is effectively "pre-compliant."
                    </p>

                    <h4 className="text-xl font-semibold text-foreground mt-8 mb-4">Tactical Execution: TDD as Governance</h4>
                    <p className="text-muted-foreground leading-relaxed">
                      MBAD enforces a strict <strong>Test-Driven Development (TDD)</strong> protocol where governance requirements are translated into executable tests <em>before</em> implementation code is written.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
                      A requirement for "Data Minimization" isn't a vague policy tick-box; it becomes a specific unit test checking that an API payload contains <em>only</em> necessary fields. If the developer (human or AI) attempts to over-fetch data, the build fails immediately. This makes compliance <strong>binary, automated, and non-negotiable</strong>.
                    </p>
                  </div>
                </div>
